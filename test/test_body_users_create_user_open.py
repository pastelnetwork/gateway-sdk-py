...
class TestBodyUsersCreateUserOpen(unittest.TestCase):
    """BodyUsersCreateUserOpen unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BodyUsersCreateUserOpen:
        """Test BodyUsersCreateUserOpen
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BodyUsersCreateUserOpen`
        """
        model = BodyUsersCreateUserOpen()
        if include_optional:
            return BodyUsersCreateUserOpen(
                password = '',
                email = '',
                full_name = '',
                balance_limit = 1.337
    ...
    def testBodyUsersCreateUserOpen(self):
        """Test BodyUsersCreateUserOpen"""
