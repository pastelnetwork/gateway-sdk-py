...
class TestBodyUsersUpdateUserMe(unittest.TestCase):
    """BodyUsersUpdateUserMe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BodyUsersUpdateUserMe:
        """Test BodyUsersUpdateUserMe
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BodyUsersUpdateUserMe`
        """
        model = BodyUsersUpdateUserMe()
        if include_optional:
            return BodyUsersUpdateUserMe(
                password = '',
                full_name = '',
                email = ''
            )
    ...
    def testBodyUsersUpdateUserMe(self):
        """Test BodyUsersUpdateUserMe"""
