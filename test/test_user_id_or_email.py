...
class TestUserIdOrEmail(unittest.TestCase):
    """UserIdOrEmail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserIdOrEmail:
        """Test UserIdOrEmail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserIdOrEmail`
        """
        model = UserIdOrEmail()
        if include_optional:
