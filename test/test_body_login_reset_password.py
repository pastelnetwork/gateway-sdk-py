...
class TestBodyLoginResetPassword(unittest.TestCase):
    """BodyLoginResetPassword unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BodyLoginResetPassword:
        """Test BodyLoginResetPassword
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BodyLoginResetPassword`
        """
        model = BodyLoginResetPassword()
        if include_optional:
            return BodyLoginResetPassword(
                token = '',
                new_password = ''
            )
        else:
    ...
    def testBodyLoginResetPassword(self):
        """Test BodyLoginResetPassword"""
