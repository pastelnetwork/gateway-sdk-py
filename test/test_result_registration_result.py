...
class TestResultRegistrationResult(unittest.TestCase):
    """ResultRegistrationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultRegistrationResult:
        """Test ResultRegistrationResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultRegistrationResult`
        """
        model = ResultRegistrationResult()
        if include_optional:
            return ResultRegistrationResult(
    ...
    def testResultRegistrationResult(self):
        """Test ResultRegistrationResult"""
